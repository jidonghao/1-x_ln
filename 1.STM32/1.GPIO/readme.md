/*************************************************************************
GPIO     LED亮灭、闪烁（指示灯 传感器采集一次闪烁一次或者串口发送一次数据闪烁一次）、流水灯

1.CubeMx配置：1、调试：图2-15
			  2、时钟树：图2-16 图2-17（PCLK1 PCLK2看试题要求）
			  3、GPIO：图2-13 图2-14（默认输出电平 圈4 LED上电不亮设置为HIGH）
2.补充代码：  1、如果需要定义全局变量    /* USER CODE BEGIN PV */  
			  ...
			  GPIO_PinState PinState：高低电平 GPIO_PIN_RESET或0
			                                   GPIO_PIN_SET或1
